...
TASKS_CONFIG=xm-influence_dtu_test_tasks
...
OUTPUT_DIR=/science/image/nlp-datasets/emanuele/results/xm-influence/flickr30kentities_vis4lang/${MODEL}_xent
...
python ablate_vis4lang.py \
        --bert_model /science/image/nlp-datasets/emanuele/huggingface/bert-base-uncased --config_file config/${MODEL_CONFIG}.json --from_pretrained ${PRETRAINED} \
