...
PRETRAINED=/science/image/nlp-datasets/emanuele/checkpoints/xm-influence/conceptual_captions_fromviz/ctrl_uniter_scratch/ctrl_uniter_base/pytorch_model_9.bin
OUTPUT_DIR=/science/image/nlp-datasets/emanuele/results/xm-influence/flickr30kentities_lang4vis/${MODEL}_fromviz-scratch
