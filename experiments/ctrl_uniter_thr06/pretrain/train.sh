...
OUTPUT_DIR=/science/image/nlp-datasets/emanuele/checkpoints/xm-influence/ctrl_uniter_thr06/conceptual_captions
LOGGING_DIR=$HOME/projects/cross-modal-influence/logs/ctrl_uniter_thr06/conceptual_captions
