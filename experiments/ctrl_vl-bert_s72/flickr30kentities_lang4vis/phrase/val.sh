...
PRETRAINED=/science/image/nlp-datasets/emanuele/checkpoints/mpre-unmasked/conceptual_captions_s73/volta/ctrl_vl-bert/ctrl_vl-bert_base/pytorch_model_9.bin
