...
OUTPUT_DIR=/science/image/nlp-datasets/emanuele/checkpoints/xm-influence/ctrl_uniter_thr02/conceptual_captions_DEBUG
LOGGING_DIR=$HOME/projects/cross-modal-influence/logs/ctrl_uniter_thr02/conceptual_captions_DEBUG
