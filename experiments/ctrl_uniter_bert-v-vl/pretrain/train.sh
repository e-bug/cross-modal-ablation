...
PRETRAINED=/science/image/nlp-datasets/emanuele/checkpoints/xm-influence/conceptual_captions_viz/${MODEL}/${MODEL_CONFIG}/pytorch_model_9.bin
OUTPUT_DIR=/science/image/nlp-datasets/emanuele/checkpoints/xm-influence/conceptual_captions_fromviz/${MODEL}
LOGGING_DIR=../../../logs/ctrl_uniter_scratch/conceptual_captions_fromviz
