...
OUTPUT_DIR=/science/image/nlp-datasets/emanuele/checkpoints/xm-influence/conceptual_captions_viz/${MODEL}
LOGGING_DIR=../../../logs/ctrl_uniter_vision/conceptual_captions_viz

source activate /science/image/nlp-datasets/emanuele/envs/xm-influence

cd ../../../volta
python train_concap_viz.py \
  --bert_model "" --config_file config/${MODEL_CONFIG}.json \
