...
OUTPUT_DIR=/science/image/nlp-datasets/emanuele/checkpoints/xm-influence/ctrl_uniter_thr02gt/conceptual_captions
LOGGING_DIR=$HOME/projects/cross-modal-influence/logs/ctrl_uniter_thr02gt/conceptual_captions
...
python train_concap.py \
  ...
  --objective 1 --threshold 0.2 --iou_type iot \
