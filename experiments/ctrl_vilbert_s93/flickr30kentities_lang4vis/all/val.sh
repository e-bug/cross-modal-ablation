...
PRETRAINED=/science/image/nlp-datasets/emanuele/checkpoints/mpre-unmasked/conceptual_captions_s93/volta/ctrl_vilbert/ctrl_vilbert_base/pytorch_model_9.bin
