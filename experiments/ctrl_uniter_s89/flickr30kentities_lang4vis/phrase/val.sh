...
PRETRAINED=/science/image/nlp-datasets/emanuele/checkpoints/mpre-unmasked/conceptual_captions_s89/volta/ctrl_uniter/ctrl_uniter_base/pytorch_model_9.bin
