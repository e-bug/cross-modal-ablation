...
class ConceptCapVizLoaderTrain(object):
    """
...
class ConceptCapVizLoaderVal(object):
    """
    Data loader. Combines a dataset and a sampler, and provides
    single- or multi-process iterators over the dataset.
    Arguments:
...
class BertPreprocessBatch(object):
    ...
    def __call__(self, data):
        ...
        cur_features = self.convert_example_to_features(cur_example, self.seq_len, None, self.region_len)
